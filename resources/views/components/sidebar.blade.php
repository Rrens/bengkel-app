             ...
             <li class="treeview {{ $active == 'restock' ? 'active' : '' }}">
                 ...
                 <ul class="treeview-menu">
                     ...
                     <li class="{{ $active_detail == 'penerimaan' ? 'active' : '' }}">
                         <a href="{{ route('restock.penerimaan.index') }}"><i class="fa fa-circle-o"></i> Penerimaan</a>
                     </li>
                 </ul>
             </li>
             ...
             <li class="treeview {{ $active == 'min-max' ? 'active' : '' }}">
                 ...
                 <ul class="treeview-menu">
                     ...
                     <li class="{{ $active_detail == 'periode' ? 'active' : '' }}">
                         <a href="{{ route('min-max.periode.index') }}"><i class="fa fa-circle-o"></i> Periode Berikutnya
                         </a>
                     </li>
                 </ul>
             </li>
